...
\resumeSubHeadingListStart
    \resumeSubheading
      {Full Stack Software Developer \textnormal{\emph{Angular, Visual Studio, SSMS, Docker}}}{ May 2025 -- August 2025}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Node,js, Git, Vim, Visual Studio, Docker, Godot, Unity, Unreal, cmdLine}
    }}
 \end{itemize}
