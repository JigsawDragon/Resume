...
\resumeSubHeadingListStart
        \resumeProjectHeading
          {\textbf{Full-Stack Task Tracker} $|$ \emph{AngularJS, SQL, .NET Core, EF Core, Docker}}{February 2025}
          \resumeItemListStart
            ...
            \resumeItem{Created a \textbf{RESTful API using .NET Core and Entity Framework Core} to handle backend task operations}
